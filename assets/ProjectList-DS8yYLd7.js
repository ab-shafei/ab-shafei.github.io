import{w as i,m}from"./media-iZHN6AWF.js";import{t as p}from"./techs-B9srv6pb.js";const r=[];function h(s){function e(t){let c="https://"+(t==="live"?"":i[t])+s[t];t==="figma"&&(c=`https://figma.com/community/file/${s[t]}`),t==="github"&&s[t].startsWith("/")&&(c=m.github+s[t]);const a=t==="cached"?"button__secondary":"",o=`${t[0].toUpperCase()}${t.slice(1)}`;return`<a href="${c}" class="button ${a}">${o} =></a>`}return Object.keys(s).map(e).join("")}const n=({id:s},e)=>{const{hasImage:t,techs:c,links:a}=r.find(o=>o.id===s);return`
        <div class="project">
